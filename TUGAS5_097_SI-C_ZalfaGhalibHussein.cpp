    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            // Meminta pengguna untuk memasukkan angka
             ...
             cout << "Akar kuadrat dari " << angka << " adalah " << akarKuadrat << endl;

             // Menghitung nilai absolut
             double nilaiAbsolut = abs(angka);
             cout << "Nilai absolut dari " << angka << " adalah " << nilaiAbsolut << endl;

             // Menghitung eksponensial
             double eksponensial = exp(angka);
             cout << "e^" << angka << " adalah " << eksponensial << endl;

             // Menghitung logaritma alami
             double logaritma = log(angka);
             cout << "Logaritma natural dari " << angka << " adalah " << logaritma << endl;
        } else {
